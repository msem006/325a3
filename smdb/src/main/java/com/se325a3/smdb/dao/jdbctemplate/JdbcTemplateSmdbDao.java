...
public class JdbcTemplateSmdbDao implements SmdbDao {
	...
	public int insertPerson(Person person) {
		...
		params.addValue("year_born", person.getYearBorn());
	...
	public Map<String, Object> insertMovie(Movie movie) {
		...
		params.addValue("year", movie.getProductionYear());
		params.addValue("country", movie.getCountry());
		params.addValue("run_time", movie.getRunTime());
		params.addValue("major_genre", movie.getMajorGenre());
		_namedParameterJdbcTemplatedbcTemplate.update(SQL_INSERT_MOVIE, params);
		
		Map<String, Object> key = new HashMap<String, Object>();
		key.put("title", movie.getTitle());
		key.put("production_year", movie.getProductionYear());
		return key; 
	}
	...
	public Map<String, Object> insertRole(Role role) {
		...
		params.addValue("year", role.getProductionYear());
		...
		key.put("production_year", role.getProductionYear());
